...
void MPI_Send(void* buf, int count, MPI_Datatype datatype, int dest, int tag,
              MPI_Comm comm);
void MPI_Rsend(void* buf, int count, MPI_Datatype datatype, int dest, int tag,
               MPI_Comm comm);
void MPI_Recv(void* buf, int count, MPI_Datatype datatype, int source, int tag,
              MPI_Comm comm, MPI_Status* status);
void MPI_Irecv(void* buf, int count, MPI_Datatype datatype, int source, int tag,
...
void MPI_Waitany(int count, MPI_Request* request, int* index,
                 MPI_Status* status);
void MPI_Sendrecv(void* sbuf, int scount, MPI_Datatype sdatatype, int dest,
...
void MPI_Cart_get(MPI_Comm comm, int maxdims, int* dims, int* periods,
                  int* coords);
void MPI_Cart_shift(MPI_Comm comm, int direction, int displ, int* source,
                    int* dest);
...
void MPI_Scan(void* sendbuf, void* recvbuf, int count, MPI_Datatype datatype,
