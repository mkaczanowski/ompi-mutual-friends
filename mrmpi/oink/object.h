...
class Object : protected Pointers {
  public:
    ...
    MapReduce* input(int);
    MapReduce* input(int, void (*)(int, char*, KeyValue*, void*), void*);
    MapReduce* input(int, void (*)(int, char*, int, KeyValue*, void*), void*);
    MapReduce* input(int, void (*)(int, char*, KeyValue*, void*),
                     void (*)(int, char*, int, KeyValue*, void*), void*);

    void output(int, MapReduce*);
    void output(int, MapReduce*, void (*)(char*, int, char*, int, void*), void*,
                int disallow = 0);
    void output(int, MapReduce*, void (*)(char*, int, char*, int, int*, void*),
                void*, int disallow = 0);
    void output(int, MapReduce*,
                void (*)(uint64_t, char*, int, char*, int, KeyValue*, void*),
                void*, int disallow = 0);
    void output(int, MapReduce*,
                void (*)(char*, int, char*, int, int*, KeyValue*, void*), void*,
                int disallow = 0);
    void output(int, MapReduce*, void (*)(char*, int, char*, int, void*),
