...
class CCStats : public Command {
  ...
  private:
    ...
    static void map_invert(uint64_t, char*, int, char*, int, KeyValue*, void*);
    static void reduce_sum(char*, int, char*, int, int*, KeyValue*, void*);
    static int compare_uint64(char*, int, char*, int);
    static void map_print(uint64_t, char*, int, char*, int, KeyValue*, void*);
};
